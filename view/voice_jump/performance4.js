...
const gravity = 0.5;
const platforms = [
    { x: 0, y: 320, width: 160, height: 80 },
    { x: 160, y: 230, width: 200, height: 180 },
    { x: 320, y: 320, width: 250, height: 80 },
    { x: 570, y: 230, width: 120, height: 180 },
    { x: 650, y: 320, width: 150, height: 80 }
];
let goal = { x: 780, y: 300, width: 20, height: 20 };
