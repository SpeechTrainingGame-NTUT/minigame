...
// 各コインの色とポイントの定義
let coinData = [
    { x: 500, y: 30, radius: 8, color: 'red', points: 30 },
    { x: 650, y: 80, radius: 8, color: 'red', points: 30 },
    ...
    { x: 420, y: platforms[1].y - 8, radius: 8, color: 'yellow', points: 10 },
...
function endGame(isCleared) {
    ...
    if(isCleared){
        ...
        const resultURL = `performance2_result.html?elapsedTime=${elapsedTime}&coinScore=${coinScore}&redCoins=${collectedCoins.red}&blueCoins=${collectedCoins.blue}&yellowCoins=${collectedCoins.yellow}`;
